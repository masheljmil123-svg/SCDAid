...
// - Avoid wording adjusted (not IM-related; CYP2D6 variability / weak opioids)
...
function buildPlan(inputs) {
  ...
  if (canOfferOxycodone(inputs, renalRisk)) {
    ...
    // Note: oxycodone is optional, not auto-added to meds
  }

  // Avoid list (wording corrected)
